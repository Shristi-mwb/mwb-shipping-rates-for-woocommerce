			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					...
					<div class="mwb-overview__keywords-text">
						...
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e( 'The cost of shipping varies depending on the price of the cart range in between the given price.',
							'mwb-shipping-rates-for-woocommerce');
							?>
						</p>
					</div>
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					...
					<div class="mwb-overview__keywords-text">
						...
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e( 'Configure the conditional rules to allow free shipping on the certain condition of the cart applied.',
							'mwb-shipping-rates-for-woocommerce');
							?>
						</p>
					</div>
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					...
					<div class="mwb-overview__keywords-text">
						...
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e( 'Phone, Email & Skype support. Our Support is ready to assist you regarding any query, issue, or feature request and if that doesn`t help our Technical team will connect with you personally and have your query
							resolved',
							'mwb-shipping-rates-for-woocommerce');
							?>
						</p>
