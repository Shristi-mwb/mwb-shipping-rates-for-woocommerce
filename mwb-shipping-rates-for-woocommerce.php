 ...
 */
	function mwb_shipping_rates_for_woocommerce_custom_settings_at_plugin_tab( $links_array, $plugin_file_name ) {
		...
		$links_array[] = '<a href="https://makewebbetter.com" target="_blank"><img src="' . esc_html(MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_URL) . 'admin/image/Demo.svg" class="mwb-info-img" alt="Demo image">'.__('Demo', 'mwb-shipping-rates-for-woocommerce').'</a>';
		$links_array[] = '<a href="https://makewebbetter.com" target="_blank"><img src="' . esc_html(MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_URL) . 'admin/image/Documentation.svg" class="mwb-info-img" alt="documentation image">'.__('Documentation', 'mwb-shipping-rates-for-woocommerce').'</a>';
