...
$msrfw_active_tab   = isset($_GET['msrfw_tab']) ? sanitize_key($_GET['msrfw_tab']) : 'mwb-shipping-rates-for-woocommerce-general';
...
<header>
    ...
    <div class="mwb-header-container mwb-bg-white mwb-r-8">
        <h1 class="mwb-header-title"><?php echo esc_attr(strtoupper(str_replace('-', ' ', $msrfw_mwb_msrfw_obj->msrfw_get_plugin_name()))); ?></h1>
        <a href="https://docs.makewebbetter.com/" target="_blank" class="mwb-link"><?php esc_html_e('Documentation', 'mwb-shipping-rates-for-woocommerce'); ?></a>
        <span>|</span>
