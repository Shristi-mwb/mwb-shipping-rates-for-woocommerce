...
class Mwb_Shipping_Rates_For_Woocommerce
{
    ...
    private function mwb_shipping_rates_for_woocommerce_admin_hooks()
    {
        ...
        // $this->loader->add_filter('msrfw_template_settings_array', $msrfw_plugin_admin, 'msrfw_admin_template_settings_page', 10);
        ...
        // $this->loader->add_action('msrfw_developer_admin_hooks_array', $msrfw_plugin_admin, 'mwb_developer_admin_hooks_listing');
        // $this->loader->add_action('msrfw_developer_public_hooks_array', $msrfw_plugin_admin, 'mwb_developer_public_hooks_listing');
        ...
        //     $this->loader->add_action('mwb_msrfw_check_license_daily', $msrfw_plugin_admin, 'mwb_msrfw_check_license');
        // }
    ...
    private function mwb_shipping_rates_for_woocommerce_common_hooks()
    {
        ...
        if ('on' === get_option( 'msrfw_radio_switch_demo')) {
            ...
            $this->loader->add_action( 'woocommerce_removed_coupon', $msrfw_plugin_common, 'srfw_coupon_remove_fun' );
    ...
    public function mwb_msrfw_plug_default_tabs()
    {
        ...
        if( self::$callname_lic() || 0 < $day_count ) {
            ...
            // $msrfw_default_tabs['mwb-shipping-rates-for-woocommerce-template'] = array(
            // 'title'       => esc_html__('Templates', 'mwb-shipping-rates-for-woocommerce'),
            // 'name'        => 'mwb-shipping-rates-for-woocommerce-template',
            // 'file_path'   =>  MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_PATH .'admin/partials/mwb-shipping-rates-for-woocommerce-template.php'
            // );

            // $msrfw_default_tabs['mwb-shipping-rates-for-woocommerce-developer'] = array(
            //     'title'       => esc_html__('Developer', 'mwb-shipping-rates-for-woocommerce'),
            //     'name'        => 'mwb-shipping-rates-for-woocommerce-developer',
            //     'file_path'   => MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_PATH . 'admin/partials/mwb-shipping-rates-for-woocommerce-developer.php'
            // );
        }
        // if ( ! get_option( 'mwb_msrfw_license_check', 0 )) {
        //     $msrfw_default_tabs['mwb-shipping-rates-for-woocommerce-license'] = array(
        //         'title'       => esc_html__('License', 'mwb-shipping-rates-for-woocommerce'),
        //         'name'        => 'mwb-shipping-rates-for-woocommerce-license',
        //         'file_path'   => MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_PATH . 'admin/partials/mwb-shipping-rates-for-woocommerce-license.php'
        //     );
        // }
    ...
    public function mwb_msrfw_plug_load_template( $path, $params = array() )
    {
        ...
        // $msrfw_file_path = MWB_SHIPPING_RATES_FOR_WOOCOMMERCE_DIR_PATH . $path;
    ...
    public function mwb_msrfw_plug_system_status()
    {
        ...
        $msrfw_system_status['outgoing_ip'] = function_exists('file_get_contents') ? file_get_contents('http://ipecho.net/plain') : __('N/A (file_get_contents function does not exist)', 'mwb-shipping-rates-for-woocommerce');
            ...
            foreach ( $msrfw_components as $msrfw_component ) {
                if (! empty($msrfw_component['type']) && ! empty($msrfw_component['id']) ) {
                    ...
                    case 'text':
                        ...
                        <div class="mwb-form-group mwb-msrfw-<?php echo esc_attr($msrfw_component['type']); ?>">
                            <div class="mwb-form-group__label">
                                <label for="<?php echo esc_attr($msrfw_component['id']); ?>" class="mwb-form-label"><?php echo ( isset($msrfw_component['title']) ? esc_html($msrfw_component['title']) : '' ); // WPCS: XSS ok. ?></label>
                            </div>
                    ...
                    case 'textarea':
                        ...
                        <div class="mwb-form-group">
                            <div class="mwb-form-group__label">
                                <label class="mwb-form-label" for="<?php echo esc_attr($msrfw_component['id']); ?>"><?php echo ( isset($msrfw_component['title']) ? esc_html($msrfw_component['title']) : '' ); // WPCS: XSS ok. ?></label>
                            </div>
                            <div class="mwb-form-group__control">
                    ...
                    case 'radio-switch':
                        ...
                        <div class="mwb-form-group">
                            <div class="mwb-form-group__label">
                                <label for="" class="mwb-form-label"><?php echo ( isset($msrfw_component['title']) ? esc_html($msrfw_component['title']) : '' ); // WPCS: XSS ok. ?></label>
                            </div>
                            <div class="mwb-form-group__control">
                                <div>
                            ...
                            <div class="mwb-form-group mwb-msrfw-<?php echo esc_attr($msrfw_component['type']); ?>">
                                ...
                                <div class="mwb-form-group__control">
                                    <label>
                                        ...
                                        type="<?php echo esc_attr($msrfw_component['type']); ?>"
                                        value="<?php echo ( isset($msrfw_component['value']) ? esc_attr($msrfw_component['value']) : '' ); ?>"
                                    <?php echo esc_html(( 'date' === $msrfw_component['type'] ) ? 'max=' . date('Y-m-d', strtotime(date('Y-m-d', mktime()) . ' + 365 day')) . 'min=' . date('Y-m-d') . '' : ''); ?>
                                        >
                                    </label>
                                    <div class="mdc-text-field-helper-line">
                                        <div class="mdc-text-field-helper-text--persistent mwb-helper-text" id="" aria-hidden="true"><?php echo ( isset($msrfw_component['description']) ? esc_attr($msrfw_component['description']) : '' ); ?></div>
